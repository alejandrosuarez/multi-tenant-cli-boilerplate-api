  ...
  paths: {
    ...
    '/api/interaction_logs': {
      get: {
        ...
        description: 'Retrieve and filter interaction logs with pagination support',
        security: [
          {
            bearerAuth: []
          }
        ...
        parameters: [
          ...
          },
          {
            name: 'start_date',
            in: 'query',
            description: 'Filter logs from this date onwards (ISO 8601 format)',
            required: false,
            schema: {
              type: 'string',
              format: 'date',
          ...
          },
          {
            name: 'source',
            in: 'query',
            description: 'Filter by custom event payload field (example)',
            required: false,
            schema: {
              type: 'string',
              example: 'manual'
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    logs: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          event_type: { type: 'string', example: 'entity_viewed' },
                          user_id: { type: 'string', example: 'user@example.com' },
                          tenant_context: { type: 'string', example: 'default' },
                          event_payload: {
                            type: 'object',
                            example: { source: 'manual', custom_data: 'value' }
                          },
                    ...
                    filters_applied: {
                      type: 'object',
                      example: { eventType: 'entity_viewed', source: 'manual' }
                    }
                  }
                }
              }
